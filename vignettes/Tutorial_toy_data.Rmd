---
title: "Tutorial Time-dependent weights using R package 'wcox'"
...
```
The weights will be calculated based on the newly add columns S_k, p_k, S_k. and p_k. . 

In the paper, sample based quantities have a hyperscript '0' which is replaced by a dot (.) here. S_k and p_k are based on the external information (incidence rate).
